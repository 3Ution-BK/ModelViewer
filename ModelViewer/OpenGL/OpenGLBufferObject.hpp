#ifndef GLFWTUTORIAL_OPENGL_BUFFEROBJECT_HPP_
#define GLFWTUTORIAL_OPENGL_BUFFEROBJECT_HPP_
...
public:
     ...
     * specified \p type and \p usagePattern.
     *
    ...
    /**
     * \brief Allocate a new \p size bytes data storage for OpenGLBufferObject.
     * Initialize with \p data.
     *
     * \par Note:
     ...
     *
     * \return Requested OpenGLBufferObject::Type value.
     */
     ...
     * OpenGLBufferObject.
     *
     * \return Requested OpenGLBufferObject::UsagePattern value.
     */
...
#endif // GLFWTUTORIAL_OPENGL_BUFFEROBJECT_HPP_
