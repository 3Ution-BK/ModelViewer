#ifndef GLFWTUTORIAL_OPENGL_OPENGLSHADER_HPP_
#define GLFWTUTORIAL_OPENGL_OPENGLSHADER_HPP_
...
public:
    ...
    /**
     * \brief Get the source code of the \p fileName and compile it to
     * OpenGLShader.
     *
    ...
    /**
     * \brief Compile the \p source content into OpenGLShader.
     *
     ...
     *
     * \return Requested OpenGLShader::Type
     */
...
#endif // GLFWTUTORIAL_OPENGL_SHADER_HPP_
